			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"conditions": {
							SchemaProps: spec.SchemaProps{
								Description: "Represents is an array of current observed MXJob conditions.",
								Type:        []string{"array"},
								Items: &spec.SchemaOrArray{
									Schema: &spec.Schema{
										SchemaProps: spec.SchemaProps{
					...
					Required: []string{"replicaStatuses", "conditions"},
				},
			},
			Dependencies: []string{
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Properties: map[string]spec.Schema{
						...
						"psRootPort": {
							SchemaProps: spec.SchemaProps{
								Description: "PsRootPort is the port to use for scheduler.",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
						"psVerbose": {
							SchemaProps: spec.SchemaProps{
								Description: "PsVerbose is the communication loggining level.",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"gone": {
							SchemaProps: spec.SchemaProps{
								Description: "The number of pods which is deleted.",
								Type:        []string{"integer"},
								Format:      "int32",
							},
						},
